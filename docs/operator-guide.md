...
1. Register operator, stores and vendors; independently confirm each
   ...
   seeding `avretailops.store`.
2. Import existing sales/inventory/return/warranty-registration, staffing
   and supply-order history.
...
5. Publish a dry-run warranty-concern flag and audit export.
...
governor-bypass resistance, evidence-backed warranty-concern reporting
